...
namespace MainPr
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                //Juego si está vivo
                if (!DED) PlayGame(ref play, ref player, ref mars, ref pause);
            ...
            //Escondido de mensaje final de consola
        ...
        //J U E G O!!
        static void PlayGame(ref bool play, ref PhySick player, ref RandWrld mars, ref bool pause)
        {
            char ch = LeeInput();
            if (ch == 'q') play = false;
            if (ch == 'p') pause = !pause;
